    ...
    <NewPage.Provider value={{ numTeamID, teamName }}>
      ...
      <section>
        <div className="flex flex-col relative">
          <div
            id="hero"
            className="md:h-[44vh] h-[50vh] md:px-0 px-8 w-full bg-[#E97848CC] m-auto flex justify-center items-center flex-col"
          >
            <Image
              src="/heading.png"
              className=""
            ...
            >
              <Image src={"/back.png"} width={10} height={10} alt="back" />
              <p className="text-[#E97848] text-[14px] font-poppins ml-3">
                Back to main page
              </p>
            </div>
          </div>
      ...
      <section className="mb-24 mx-auto">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:items-center">
          <p class="text-3xl text-[#B05C39] font-poppins font-bold sm:ml-28">
            {headingName[0]} Team Pledges
          </p>
          <div
            onClick={() => router.back()}
            class="bg-[#B05C39] text-white text-sm rounded-full flex items-center justify-center h-8 px-2 mt-3 sm:mt-0 sm:ml-5 cursor-pointer"
          >
            View all Pledges
          </div>
        </div>
          ...
          {filteredData.reverse().map((val, id) => {
            return (
              <>
                <div
                  key={id}
                  className="bg-[#FAE2D8] flex flex-col p-2 w-[85%] md:w-[25%]"
                >
                  {val.anonymous !== true ? (
                    <p className="text-[#B05C39] font-bold font-poppins ml-2 text-[16px]">
                  ...
                  <p className="text-[#B05C39] font-poppins w-[90%] text-[12px] ml-2 mt-1">
                    {val.mitzvah}
                  </p>
                  <p className="text-[#B05C39]  font-poppins text-[12px]  ml-2 mt-1">
