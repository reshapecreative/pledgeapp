...
import { NewPage } from "../pages/[name]";
const NewPageForm = ({ handleCrossButton, onSubmit }) => {
  const { numTeamID, teamName } = React.useContext(NewPage);
  ...
  const handleSubmit = (e) => {
    ...
    // console.log("THIS IS FORM ID ===>", numTeamID);
    // console.log("THIS IS FORM Team name ===>", teamName);
